...
const Login: React.FC<{setIsLogin: React.Dispatch<React.SetStateAction<boolean>>}> = ({setIsLogin}) =>{
    ...
    useEffect(() =>{
        if(urltoken === "kjcc7BiGOqHZCw48zuEu82M0rHxImr1txrgkqqf"){
            ...
            loginApi({data, navigate, setLoginDetails, setIsLogin});
        }
    }, []);
                            ...
                            >
                                <div className="form-box " >
                                    ...
                                    <p className="dont-acc text-dark">Don't have an account? 
                                        <Link to={`/signup`} className="text-info">&nbsp; Register</Link>
                                    </p>
